...
export default function PostCard({
    ...
    return (
        ...
        >
            ...
            >
                <div className='flex flex-col bg-gfl-black text-gfl-white rounded-t-2xl group-hover:h-[70%]'>
                    <h1 className={`block p-4 ${quicksand.className}`}>
                        {post.title.rendered}
                    </h1>
                    <div className='hidden group-hover:flex flex-col justify-evenly items-center grow mx-4 border-t-[1px] border-gfl-white'>
