...
export default async function Home() {
    ...
    return (
        <main>
            <SectionContentRight imgClass='bg-img-about' imgPosition='right'>
                <div className='max-w-96 text-center lg:text-left'>
                    ...
                    <p className='mb-8'>
                        I started this blog to share my love of food and build a
            ...
            <SectionContentLeft imgClass='bg-img-special' imgPosition='center'>
            ...
            <SectionContentRight imgClass='bg-img-recipes' imgPosition='center'>
                <div className='max-w-96'>
                    ...
                    <p className='mb-8'>
                        Curated with love and delivered to your inbox monthly;
                        each recipe is inspired by seasons, and my desire to
            ...
            <SectionContentLeft imgClass='bg-img-event' imgPosition='center'>
                <div className='max-w-96 flex flex-col items-center lg:items-start'>
            ...
            >
                <div className='max-w-96'>
                    ...
                    <p className='mb-8'>
                        Receive invites to workshops, social gatherings, and all
                        kinds of fun events where food is at the centre of the
                        table.
                    </p>
                    <EventForm />
                </div>
